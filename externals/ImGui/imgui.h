...
namespace ImGui
{
    ...
    IMGUI_API void          TaskesyAddColumn();                                                                                         // Taskesy add column
    ...
    IMGUI_API void          ShowTaskesyWindow(bool* p_open = NULL, int* ptrCurrentBoxID = NULL, int* ptrCurrentBoxColumn = NULL, int* ptrCurrentColumn = NULL);       // Show Taskesy Window
